...
class Wsdm_Post_Mailer
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wsdm_Post_Mailer_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'wsdm-post-mailer';
	 ...
	 *
	 * - Wsdm_Post_Mailer_Loader. Orchestrates the hooks of the plugin.
	 * - Wsdm_Post_Mailer_i18n. Defines internationalization functionality.
	 * - Wsdm_Post_Mailer_Admin. Defines all hooks for the admin area.
	 * - Wsdm_Post_Mailer_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wsdm_Post_Mailer_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
